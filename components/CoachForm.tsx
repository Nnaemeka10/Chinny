...
const CoachForm = () => {
  return (
    <section id='Life_coach_form' className="bg-white flex w-full min-h-screen overflow-hidden no-scrollbar">
      {/* Outer container */}
      <div className="flex flex-col min-h-screen flex-grow">
        {/* Main content */}
        <div className="pt-6 flex flex-col flex-grow relative z-10">
          <div className="pt-12 pb-6 flex justify-center">
          <h1 className='text-2xl font-medium text-gray-900 mb-4'>Book Coaching Session</h1>
          </div>
