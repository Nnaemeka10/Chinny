...
const About = () => {
  ...
  return (
    <section id='about-page' className='bg-white-10 max-container px-4 flex flex-col gap-4 py-24 pb-22 lg:py-20 lg:px-6'>

      <h1 className='text-4xl font-medium text-gray-900 mb-4 text-center'>About me</h1>


      <div className='flex flex-col-reverse lg:flex-row gap-2 lg:gap-5 text-center lg:px-24'>
        <div className="max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow-sm lg:w-2/3">
          <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900"><span className='text-blue-20'>Hello</span>, I am Dr Nduka Chiamaka Chinweoke</h5>
          <p className="mb-3 font-normal text-gray-500">
            I am an <span className='text-blue-20 font-medium'>optometrist</span>,a <span className='text-blue-20 font-medium'>mental health advocate</span> and the <span className='text-blue-20 font-medium'>CEO of chiniphotos.</span> <br /> {description} 
          </p>
