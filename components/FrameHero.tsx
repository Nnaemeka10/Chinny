...
const FrameHero = () => {
  return (
    <section className="relative max-container px-1 flex flex-col gap-20 py-5 pb-22 lg:py-20 lg:px-6 hide-scrollbar animate-fade-in">
        ...
        {/* overlay text */}
        <div className="relative flex flex-col items-center justify-center p-8 gap-10 inset-0 h-48 -top-96 -mb-80" >
            <div className="relative text-center max-w-full bg-black/20 rounded-lg w-full">
                <h1 className="text-5xl font-medium text-white-10 mb-4">
                    Protect Your Vision
                </h1>
