    ...
    <section className="bg-white flex w-full min-h-screen overflow-hidden no-scrollbar relative flex-col">
        <div className="pt-6 flex flex-col flex-grow relative z-10">
          ...
          <div className="w-full">
            <div className="mx-auto w-full max-w-[448px] bg-white-10 rounded shadow-lg mb-40">
              <div className="px-12 py-12">
                <span className="block text-xl leading-7 text-[#1a1f36] pb-4">
                  Please input your details
                </span>
                <form id="eye-consult" action='https://formsubmit.co/20aea8516128f7977f3780fda8633b44'  method='POST'>
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      type="email"
                      name="email"
                      className="text-base leading-7 px-4 py-2 w-full min-h-[44px] border-0 rounded outline-blue-500 bg-white-10 shadow-[0_0_0_1px_rgba(60,66,87,0.16)]"
                    />
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <select
                      name="age"
                      defaultValue='default'
                      className="text-base leading-7 px-2 py-2 w-full min-h-[44px] border-0 rounded outline-blue-500 bg-white-10 shadow-[0_0_0_1px_rgba(60,66,87,0.16)] flex flex-1 text-gray-800 cursor-pointer appearance-none select overflow-hidden relative" 
                    >
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      autoComplete='off'                   
                      name="complaint"
                      className="text-base leading-7 px-4 py-2 w-full min-h-[44px] border-0 rounded outline-blue-500 bg-white-10 shadow-[0_0_0_1px_rgba(60,66,87,0.16)] hide-scrollbar"
                    />
                  </div>
